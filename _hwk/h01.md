...
Section 2.1 describes how several operators and built in functions in Python work. What would be the result of entering the following at the Python interactive shell prompt?
...
Indicate the value and type (bool, int, float, str)of each of these expressions:
...
| | Expression  | <span class="wider">Result</span> | <span class="wider">Type</span>| | | Expression  | <span class="wider">Result</span> | | <span class="wider">Type</span> |
|---------|-------------|--------|----|-|--------|-------------|--------|----|
| (4 pts) | `school * 2`        |  | | (4 pts) | `school > course` | |
| (4 pts) | `len(qtr[1:3])`          |  | |(4 pts) | `qtr < school`   | |
